...
- **狙击榜单**：自动统计与你互动频繁的玩家（相互击杀2次以上），一眼识别"老冤家"
- **疑似狙击标记**：在死亡笔记中自动标记狙击榜单中的玩家，快速定位恩怨局
- **AI 识别**：自动识别并标记 AI 玩家，区分真实对手与人机
...
- **狙击榜单**：统计与你互动2次以上的玩家，按互动次数排序，支持展开查看详细对战记录
- **疑似狙击标记**：死亡笔记中自动为狙击榜单玩家打上 🎯 标记，恩怨局一目了然
- **AI 识别**：自动标记 AI 玩家，区分真实对手与人机
...
│   │   ├── kill-event.service.ts   # 击杀事件查询与狙击榜单统计
